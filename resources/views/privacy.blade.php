    ...
    <div class="container">
        <div class="row pt-5">
            <div class="col pt-5">
                ...
                <p>At Ya Tha Sone, accessible from <a href="http://zakerxa.com">http://zakerxa.com</a> , one of our main
                ...
                <p>Ya Tha Sone follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, Ya Tha Sone uses 'cookies'. These cookies are used to store information
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Ya Tha
                    Sone.</p>

                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Ya Tha Sone, which are sent
                ...
                <p>Note that Ya Tha Sone has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>Ya Tha Sone's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <p>Ya Tha Sone does not knowingly collect any Personal Identifiable Information from children under the
